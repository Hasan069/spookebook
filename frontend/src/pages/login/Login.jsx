...
const Login = () => {
  return (
    <body className="font-Roboto font-semibold m-0 p-0 box-border flex justify-center items-center min-h-screen bg-cover bg-center bg-no-repeat ">
      <div
        className="wrapper w-96 backdrop-filter backdrop-blur-lg text-white rounded-xl pt-8 pb-8 pr-9 pl-9 border-2  border-orange-800"
      >
        <form>
          ...
          <div
            className="remember-forget flex justify-between text-sm -mt-4 mr-0 mb-4 ml-0"
          >
          ...
          <div
            className="register-link text-sm text-center mt-5 mr-0 ml-0 mb-4 "
          >
