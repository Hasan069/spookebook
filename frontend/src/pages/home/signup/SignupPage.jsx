...
const SignupPage = () => {
    return (
        ...
        <body className="font-Roboto font-semibold m-0 p-0 box-border flex justify-center items-center min-h-screen bg-cover bg-center bg-no-repeat ">
            <div class="wrapper" className="w-1/4 bg-transparent text-white rounded-xl pt-8 pb-8 pr-9 pl-9 border-2 border-y-red-400 border-x-purple-400">
                <form>
                    <h1 className="text-3xl text-center ">SignUp</h1>

                    <div class="" className='flex'>
                        <div className="w-full h-16 mt-2 pr-1" >
                            <input type="text" placeholder="First Name" required className="relative w-full h-full bg-transparent border-solid border-2 divide-red-400 rounded-3xl placeholder:text-white text-base pt-5 pr-11 pb-5 pl-5" />

                        </div>
                        <div className="w-full h-16 mt-2 px-1" >
                            <input type="text" placeholder="Last Name" required className="relative w-full h-full bg-transparent border-solid border-2 divide-red-400 rounded-3xl placeholder:text-white text-base pt-5 pr-11 pb-5 pl-5" />
                    ...
                    <div className="w-full h-16 my-8" >
                        <input type="text" placeholder="Email" required className="relative w-full h-full bg-transparent border-solid border-2 divide-red-400 rounded-3xl placeholder:text-white text-base pt-5 pr-11 pb-5 pl-5" />
                        <IoMailUnreadSharp class="icon " className="absolute right-[43%] top-2/ -translate-y-11" />
                    </div>

                    <div className="w-full h-16 my-8">
                        <input type="text" placeholder="Create password" required className=" relative w-full h-full bg-transparent border-solid border-2 divide-red-400 rounded-3xl placeholder:text-white text-base pt-5 pr-11 pb-5 pl-5"></input>
                        <FaUnlock class="icon " className="absolute right-[43%] top-2/ -translate-y-11" />
                    </div>
                    <div className="w-full h-16 my-8">
                        <input type="text" placeholder="Confirm password" required className=" relative w-full h-full bg-transparent border-solid border-2 divide-red-400 rounded-3xl placeholder:text-white text-base pt-5 pr-11 pb-5 pl-5"></input>
                        <FaUnlock class="icon " className="absolute right-[43%] top-2/ -translate-y-11" />
                    </div>
                    ...
                    <div class="register-link" className="text-sm text-center mt-5 mr-0 ml-0 mb-4 ">
                        <p className="to-white decoration-none font-semibold ">Already have an accout? <a className="hover:underline decoration-1" href="#">Login</a></p>
                    </div>
                </form>
            </div>
        </body>
